...
export default function ContactPage() {
  ...
  return (
    <div className="bg-neutral-900 min-h-screen">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 py-16">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-12">
              ...
              <Reveal x={-30}>
                <div className="flex gap-6 items-start group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 leading-relaxed">{restaurantConfig.address}</p>
                    <a href={restaurantConfig.googleMapsUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 mt-3 text-brand-primary hover:text-white transition font-bold text-xs uppercase tracking-widest">
            ...
            {(restaurantConfig.phone || restaurantConfig.email) && (
                ...
                <div className="flex gap-6 items-start group">
                  ...
                  <div>
                    ...
                    {restaurantConfig.phone && (
                      <p className="text-gray-400">Tél : <a href={`tel:${restaurantConfig.phone}`} className="text-white hover:text-brand-primary font-bold transition text-lg tracking-tighter">{restaurantConfig.phone}</a></p>
                    )}
                    {restaurantConfig.email && (
                      <p className="text-gray-400">Email : <a href={`mailto:${restaurantConfig.email}`} className="text-white hover:text-brand-primary font-bold transition">{restaurantConfig.email}</a></p>
                    )}
                  </div>
                </div>
              </Reveal>
      ...
      {restaurantConfig.googleMapsUrl && restaurantConfig.googleMapsUrl !== "https://maps.google.com" && (
        <div className="w-full h-112.5 bg-neutral-800 border-t border-neutral-800 relative">
          <iframe
            src={restaurantConfig.googleMapsUrl}
            title={`Plan d'accès ${restaurantConfig.name}`}
            width="100%"
            height="100%"
            style={{ border: 0 }}
