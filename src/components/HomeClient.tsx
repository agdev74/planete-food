  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-6 flex flex-col items-center text-center gap-8 py-32">
          ...
          <h1 className="w-full text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-display font-bold uppercase leading-none tracking-tighter text-center flex flex-col items-center justify-center">
            <span className="text-white block text-center">LE PREMIER</span>
            <span className="text-white block text-center">FOOD COURT</span>
            <span className="block text-transparent bg-clip-text bg-linear-to-br from-brand-primary to-violet-300 text-center">
              LIVRÉ CHEZ VOUS
            </span>
          </h1>
          ...
          <Reveal delay={0.15}>
            <div className="flex justify-center w-full">
              <p className="text-white/80 font-bold text-lg md:text-2xl tracking-tight max-w-xl text-center mx-auto">
          ...
          <Reveal delay={0.25} y={20}>
            <div className="flex justify-center w-full mt-4">
              <Link
                ...
                className="group inline-flex items-center justify-center gap-3 px-12 py-5 bg-brand-primary text-white font-black rounded-2xl hover:bg-violet-600 hover:scale-105 active:scale-100 transition-all duration-300 uppercase tracking-widest shadow-glow text-sm md:text-base mx-auto"
              >
          ...
          <Reveal delay={0.45}>
            <div className="flex justify-center w-full">
              <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 pt-8 mt-4 border-t border-white/5 w-full max-w-3xl">
