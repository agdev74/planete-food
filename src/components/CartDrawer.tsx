...
const cartTranslations = {
  fr: {
    ...
    couponLabel: "Code Promo", couponPlaceholder: "EX: PROMO10", couponBtn: "Appliquer", couponInvalid: "Code invalide ou expiré", couponMinError: "Min. {min} CHF requis", discount: "Réduction"
  },
  en: {
    ...
    couponLabel: "Promo Code", couponPlaceholder: "EX: PROMO10", couponBtn: "Apply", couponInvalid: "Invalid or expired", couponMinError: "Min. {min} CHF required", discount: "Discount"
  },
  es: {
    ...
    couponLabel: "Código Promo", couponPlaceholder: "EJ: PROMO10", couponBtn: "Aplicar", couponInvalid: "Inválido o expirado", couponMinError: "Min. {min} CHF requerido", discount: "Descuento"
  }
};
